	...
	<div class="flex flex-col md:flex-row p-2 md:px-16 my-0 mx-auto ">
		...
		<div id="col-izq" class="bg-neutral md:p-3 py-4 my-4 md:rounded-none rounded-lg space-y-4 md:w-3/5">
			...
			<div class="flex justify-between px-2 md:px-5 items-center">
				<input id="invoice_num" type="hidden" value="<?php echo $data['invoice'] ?>">
				<input id="root" class="hidden" data-controller="<?php echo  $data['controller'] ?>" data-url="<?php echo URLROOT ?>">
				<div id="chapter" class="space-x-10 text-4xl md:text-6xl font-bold" 
						data-comic="<?php echo $data['comic']->nombre ?>" 
						data-price="<?php echo $data['chapter']->precio ?>" 
						data-chapter="<?php echo $data['chapter']->titulo ?>" 
						data-quant="1" 
						data-comicId="<?php echo $data['chapter']->proyecto_id ?>" 
						data-chapterNum="<?php echo $data['chapter']->cap_num ?>" >
...
<script src="https://www.paypal.com/sdk/js?client-id=AX7EiVX0nGcW0Y1fniAIVzeQ1rtjRJTeBj3YcqNfYMpAcxPCcOhw8H2bLmk7hyKa6TbYdeXNstyQCuPY"></script>
